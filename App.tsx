...
// Fix: Moved NavItem to top-level once to avoid redeclaration errors
      ...
      <header className="bg-white p-8 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-100 flex flex-col md:flex-row items-center gap-10">
        <div className="flex-shrink-0">
          <div className="flex items-center justify-center transition-transform hover:scale-105">
             <svg width="220" height="60" viewBox="0 0 350 90" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="text-center md:text-left flex-1 space-y-3">
          <div className="flex flex-col items-center md:items-start">
            <div className="inline-block text-center">
              <h2 className="text-3xl md:text-5xl font-black text-gray-900 leading-[0.9] uppercase italic tracking-tighter">
            ...
            <p className="text-lg md:text-xl font-bold text-gray-500 uppercase tracking-tight mt-2 w-full text-center md:text-left">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-[2rem] shadow-sm border overflow-hidden"><table className="w-full text-left">
        ...
        {/* Fix: Changed handleDeleteTransaction to deleteTransaction from props */}
