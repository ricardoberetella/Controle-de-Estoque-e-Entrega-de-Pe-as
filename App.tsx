...
const Dashboard: React.FC<{ summary: StockSummary[], students: Student[] }> = ({ summary, students }) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      {/* Cabeçalho Proeminente Atualizado (Logo Removido) */}
      <header className="bg-white p-8 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-100 flex flex-col md:flex-row items-center gap-6">
        <div className="flex-shrink-0">
          <div className="p-6 bg-red-600 rounded-2xl shadow-lg shadow-red-200 flex flex-col items-center justify-center min-w-[140px]">
             <span className="text-white font-black text-3xl italic leading-none tracking-tighter">SENAI</span>
             <span className="text-red-100 font-bold text-[10px] uppercase tracking-[0.2em] mt-1">Usinagem</span>
          </div>
        </div>
